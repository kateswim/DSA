...
print(verify_sudoku_board(board))  # Should return True if the board is valid
board_invalid = [
    [5, 3, 0, 0, 7, 0, 0, 0, 0],
    [6, 0, 0, 1, 9, 5, 0, 0, 0],
    [0, 9, 8, 0, 0, 0, 0, 6, 0],
...
board_invalid[0][0] = 6  # invalid number
print(verify_sudoku_board(board_invalid)) # Should return False if the board is invalid